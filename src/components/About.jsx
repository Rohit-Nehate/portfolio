    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-5 relative group">
          <motion.div
            className="aspect-square rounded-lg overflow-hidden glass-panel p-2! relative z-10"
        ...
        <div className="md:col-span-7 md:pl-12!">
          ...
          <div className="flex flex-wrap gap-3 mt-8!">
            {personal.stats.map((stat) => (
              <span
                key={stat}
                className="glass-panel px-4! py-2! rounded-xl font-[JetBrains_Mono] text-[14px] leading-normal text-xs text-[#e5e2e1]"
              >
                {stat}
              </span>
            ))}
