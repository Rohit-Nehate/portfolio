...
export default function Journey() {
  return (
    <div>
      ...
      <motion.div
        className="max-w-3xl mx-auto! space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-linear-to-b before:from-transparent before:via-white/10 before:to-transparent"
        ...
        {journey.map((item, index) => (
          ...
          >
            ...
            <div
              ...
              } bg-[#131313] shadow-sm shrink-0 md:order-1 ${
                index % 2 === 0
            ...
            {/* Card */}
            <div
              className={`w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] glass-panel p-6! rounded-lg hover:-translate-y-1 transition-transform duration-300 ${
